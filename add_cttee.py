...
from helpers_cttees_api import *
...
def main():
    ...
    cttees = fetch_committees_dict('Select', 
        ['(HC) Public Standing Orders - Cross-cutting', 
         '(HC) Public Standing Orders - Departmental',
         '(HC) Public Standing Orders - Domestic'
        ], 
        False
    )
    ...
    if cttee_id in cttees:
        ...
        helpers_mapping_csv.update_mapping_CSV(cttee_id, cttee_name, interest_id) #campaign_id, interest_id)
    else:
